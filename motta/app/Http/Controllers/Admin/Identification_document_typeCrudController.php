 ...
 */
class Identification_document_typeCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Identification_document_type::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/identification_document_type');
        CRUD::setEntityNameStrings('tipo de documento de identidad', 'tipos de documento de identidad');
